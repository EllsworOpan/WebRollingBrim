    ...
    <div className="workbench">
      <aside className="sidebar">
        ...
        <details className="print-details"><summary><span><Settings2 size={15} /> Print settings</span><ChevronDown size={15} /></summary><div className="print-settings-body">
          ...
          <NumberControl label="Travel lift" value={settings.travelLift} min={0} max={Math.max(5, loaded?.job.settings.zHop || 0)} step={0.1} onChange={value => update('travelLift', value)} description="Z-hop between brim paths. Source entry and handoff heights are preserved, including when this is zero." />
