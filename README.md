...
- Travel lift is measured from the exact saved nozzle Z. When the footer includes `max_print_height`, generation and export reject a lift exceeding that height. The value must still describe the actual printer; it cannot account for physical obstacles.
